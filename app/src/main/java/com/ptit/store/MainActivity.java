...
import com.ptit.store.adapter.FragmentAdapter;
...
import com.ptit.store.presenter.home.HomePresenter;
import com.ptit.store.presenter.home.HomePresenterImpl;
...
import com.ptit.store.view.about.AboutActivity;
import com.ptit.store.view.account.login.LoginActivity;
import com.ptit.store.view.account.password.change_password.ChangePasswordActivity;
import com.ptit.store.view.account.password.reset_password.ForgetPasswordActivity;
import com.ptit.store.view.account.register.RegisterActivity;
import com.ptit.store.view.cart.CartActivity;
import com.ptit.store.view.chat.ChatActivity;
import com.ptit.store.view.feedback.FeedbackActivity;
import com.ptit.store.view.history_order.HistoryOrderActivity;
import com.ptit.store.view.manage_order.ManageOrderActivity;
import com.ptit.store.view.map.MapsActivity;
import com.ptit.store.view.profile.ProfileActivity;
import com.ptit.store.view.rate.RateActivity;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.addSpaceItem(new SpaceItem("", R.mipmap.ic_bag));
        bottomNavigationView.addSpaceItem(new SpaceItem("", R.drawable.ic_search));
        bottomNavigationView.addSpaceItem(new SpaceItem("", R.mipmap.ic_heart));
        bottomNavigationView.addSpaceItem(new SpaceItem("", R.drawable.ic_logo_store_gray));
    ...
    private SpaceOnClickListener mOnNavigationItemSelectedListener
        ...
        public void onItemClick(int itemIndex, String itemName) {
            switch (itemIndex) {
                ...
                case 1: {
                    toolbar.setTitle(R.string.Searching);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.nav_logout: {
                ...
                FirebaseMessaging.getInstance().unsubscribeFromTopic(Utils.getSharePreferenceValues(this, Constants.PRE_USER_ID));
            ...
            case R.id.nav_facebook: {
                if (Utils.checkNetwork(this)) {
                    String url = "https://www.facebook.com/profile.php?id=100011839334572";
    ...
    public void switchNavigationDrawer(boolean isLoggedIn) {
        ...
        if (isLoggedIn) {
            ...
            if (headerProfile == null) {
                homePresenter.fetchHeaderProfile();
            } else {
