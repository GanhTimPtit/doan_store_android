package com.ptit.store.view.profile.update_profile;
...
import com.ptit.store.presenter.profile.edit_profile.EditProfilePresenter;
import com.ptit.store.presenter.profile.edit_profile.EditProfilePresenterImpl;
...
public class UpdateProfileActivity extends AppCompatActivity implements View.OnClickListener, UpdateProfileView {
    ...
    private void initData() {
        ...
        if (intent != null) {
            ...
            edt_firstName.setText(profile.getFullName() == null ? null : profile.getFullName().substring(0,profile.getFullName().lastIndexOf(" ")));
            edt_lastName.setText(profile.getFullName() == null ? null : profile.getFullName().substring(profile.getFullName().lastIndexOf(" ")+1, profile.getFullName().length()));
    ...
    void initWidget() {
        ...
        edt_firstName = findViewById(R.id.edt_first_name);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.mn_done: {
                ...
                presenter.validateProfile(uri, edt_firstName.getText().toString(),edt_lastName.getText().toString(),
    ...
    public void showFullNameError() {
        edt_lastName.setError(getString(R.string.must_not_empty));
    }
