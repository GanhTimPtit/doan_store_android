...
import com.ptit.store.adapter.AddressAdapter;
...
import com.ptit.store.models.SingleShotLocationProvider;
import com.ptit.store.models.google_map.Address;
import com.ptit.store.models.google_map.Location;
import com.ptit.store.presenter.maps.LocationPickerPresenter;
import com.ptit.store.presenter.maps.LocationPickerPresenterImpl;
...
public class LocationPickerActivity extends AppCompatActivity implements LocationPickerActivityView,
        OnMapReadyCallback,
    ...
    protected void initData(Bundle savedInstanceState) {
        presenter= new LocationPickerPresenterImpl(this, this);
    }
    ...
    private void initToolBar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(R.string.enter_address);
        }
    }
    ...
    public void showShopMarkerAt(LatLng latLng, String address) {
        ...
        if (address == null || address.isEmpty()) {
            presenter.fetchMapAddress(latLng.latitude, latLng.longitude);
        } else {
    ...
    public boolean onQueryTextChange(String newText) {
        if (newText.isEmpty()) {
            ...
            presenter.queryMapAddress(newText);
        }
        return false;
    }
