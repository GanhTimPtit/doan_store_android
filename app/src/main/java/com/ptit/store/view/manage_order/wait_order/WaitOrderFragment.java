package com.ptit.store.view.manage_order.wait_order;
 ...
 */
public class WaitOrderFragment extends Fragment implements ManageOrderFragmentView,
    ...
    public void onClick(int pos) {
        positionDelete=pos;
        OrderPreview orderPreview = this.adapter.getItem(pos, OrderPreview.class);
        presenter.deleteOrder(orderPreview.getId());
    }
}
